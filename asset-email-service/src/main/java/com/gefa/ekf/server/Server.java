...
import com.gefa.ekf.boundary.inbound.rest.error.handlers.EmailExceptionHandler;
import com.gefa.ekf.boundary.inbound.rest.resources.EmailResourceImpl;
...
/*
	public static UndertowJaxrsServer startServer_working() {
		...
		di.setContextPath("/asset-email-service");
...
*/
	...
	public static UndertowJaxrsServer startServer() {
		System.setProperty("org.jboss.resteasy.port", "8083");
		UndertowJaxrsServer server = new UndertowJaxrsServer().start();
	...
	public static class MyApp extends Application {
		...
		public Set<Class<?>> getClasses() {
			...
			classes.add(EmailResourceImpl.class);
			classes.add(ExceptionHandler.class);
			classes.add(EmailExceptionHandler.class);
